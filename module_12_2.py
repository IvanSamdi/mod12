...
class TournamentTest(unittest.TestCase):
    ...
    def test_turn1(self):
        self.tur_1 = runner_and_tournament.Tournament(90, self.runner1, self.runner3)
    ...
    def test_turn2(self):
        self.tur_2 = runner_and_tournament.Tournament(90, self.runner2, self.runner3)
        self.all_results = self.tur_2.start()
        self.assertTrue(self.all_results[list(self.all_results.keys())[-1]] == 'Ник')
        TournamentTest.all_results[2] = self.all_results

    def test_turn3(self):
        self.tur_3 = runner_and_tournament.Tournament(90, self.runner1, self.runner2, self.runner3)
